...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogPost.speakers'
        db.add_column(u'blog_blogpost', 'speakers',
                      self.gf('django.db.models.fields.CharField')(default='Not specified', max_length=400),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogPost.speakers'
        db.delete_column(u'blog_blogpost', 'speakers')
    ...
    models = {
        ...
        u'blog.blogpost': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'}),
            'speakers': ('django.db.models.fields.CharField', [], {'max_length': '400'}),
