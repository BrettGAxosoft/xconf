...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlogPost.office'
        db.add_column(u'blog_blogpost', 'office',
                      self.gf('django.db.models.fields.CharField')(default='Not specified', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlogPost.office'
        db.delete_column(u'blog_blogpost', 'office')
    ...
    models = {
        ...
        u'blog.blogpost': {
            ...
            'office': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
